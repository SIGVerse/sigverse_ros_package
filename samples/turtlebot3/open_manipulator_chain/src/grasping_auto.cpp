...
void SIGVerseTb3OpenManipulatorGraspingAuto::keyLoop(int argc, char** argv)
{
  ...
  try
  {
    ...
    node_handle.param<std::string>("sub_rgb_camera_info_topic_name",  sub_rgb_camera_info_topic_name,  "/camera/rgb/camera_info");
    node_handle.param<std::string>("sub_point_cloud_topic_name",      sub_point_cloud_topic_name,      "/camera/depth/points");
